...
class FareCalculatorTest {
    ...
    public void defaultConstructor() {
        assertThat(FareCalculator.calculate(new Distance(5), new Age(20))).isEqualTo(1250);
    }
    ...
    public void calculateFareByDistance(int distance, int expectedFare) {
        assertThat(FareCalculator.calculate(new Distance(distance), new Age(20))).isEqualTo(expectedFare);
    }
    ...
    public void discountToTeenager(int distance, int expectedFare) {
        assertThat(FareCalculator.calculate(new Distance(distance), new Age(15))).isEqualTo(expectedFare);
    }
    ...
    public void discountChildren(int distance, int expectedFare) {
        assertThat(FareCalculator.calculate(new Distance(distance), new Age(8))).isEqualTo(expectedFare);
    }
}
