...
class LineServiceTest {
    ...
    @Test
    void create() {
        Line line = lineService.create("신분당선", "bg-red-600", 1000, section);
        assertAll(
    ...
    void duplicateNameException() {
        lineService.create("신분당선", "bg-red-600", 1000, section);

        assertThatThrownBy(() -> lineService.create("신분당선", "bg-blue-600", 1000, section))
    ...
    void listLines() {
        lineService.create("신분당선", "bg-red-600", 1000, section);
        lineService.create("2호선", "bg-red-600", 200, section);
        lineService.create("분당선", "bg-red-600", 1000, section);
    ...
    void update() {
        Line line = lineService.create("신분당선", "bg-red-600", 1000, section);
        Line updatedLine = lineService.update(new Line(line.getId(), "분당선", "bg-blue-600", 500));
    ...
    @Test
    void addSectionLeft() {
        Line line = lineService.create("2호선", "bg-red-600", 200, section);
