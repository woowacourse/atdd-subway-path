...
public class StationAcceptanceTest extends AcceptanceTest {
    ...
    void createStation() {
        // when
        ExtractableResponse<Response> response = 지하철역_생성_요청(강남역, 사용자);
    ...
    void getStations() {
        // given
        StationResponse stationResponse1 = 지하철역_등록되어_있음(강남역, 사용자);
        StationResponse stationResponse2 = 지하철역_등록되어_있음(역삼역, 사용자);
    ...
    void deleteStation() {
        // given
        StationResponse stationResponse = 지하철역_등록되어_있음(강남역, 사용자);

        // when
        ExtractableResponse<Response> response = 지하철역_제거_요청(stationResponse, 사용자);

        // then
        지하철역_삭제됨(response);
    }

    public static StationResponse 지하철역_등록되어_있음(String name, TokenResponse 사용자) {
        return 지하철역_생성_요청(name, 사용자).as(StationResponse.class);
    }
