...
class SectionRepositoryTest extends DatabaseUsageTest {
    ...
    void deleteSections_메서드는_구간들을_제거() {
        databaseFixtureUtils.saveSection(1L, 강남역, 잠실역, 10);
        databaseFixtureUtils.saveSection(1L, 잠실역, 선릉역, 15);
        databaseFixtureUtils.saveSection(1L, 선릉역, 청계산입구역, 5);
        databaseFixtureUtils.saveSection(2L, 강남역, 선릉역, 5);
