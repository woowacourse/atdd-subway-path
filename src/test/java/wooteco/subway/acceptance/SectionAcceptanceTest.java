...
public class SectionAcceptanceTest extends AcceptanceTest {
    ...
    void saveSection() {
        ...
        Long stationId3 = postStations(new StationSaveRequest("선릉역"))
                .as(StationResponse.class)
                .getId();
        Long lineId = postLines(new LineSaveRequest("신분당선", "bg-red-600", stationId1, stationId3, 10, 100))
    ...
    void removeSection() {
        ...
        Long lineId = postLines(new LineSaveRequest("신분당선", "bg-red-600", stationId1, stationId2, 10, 100))
                .as(LineResponse.class)
                .getId();
