...
class LineAcceptanceTest extends AcceptanceTest {
    ...
    void createLine() {
        // when
        LineRequest newLineRequest = new LineRequest("6호선", "bg-yellow-600", 2L, 3L, 20, 0);
    ...
    private static Stream<Arguments> thrownArguments() {
        return Stream.of(
                Arguments.of(new LineRequest("", "bg-purple-600", 1L, 2L, 10, 0), "노선 이름은 공백일 수 없습니다."),
                Arguments.of(new LineRequest(null, "bg-purple-600", 1L, 2L, 10, 0), "노선 이름은 공백일 수 없습니다."),
                Arguments.of(new LineRequest("이름", "", 1L, 2L, 10, 0), "노선 색상은 공백일 수 없습니다."),
                Arguments.of(new LineRequest("이름", null, 1L, 2L, 10, 0), "노선 색상은 공백일 수 없습니다."),
                Arguments.of(new LineRequest("이름", "색상", null, 2L, 10, 0), "상행역은 비어있을 수 없습니다."),
                Arguments.of(new LineRequest("이름", "색상", 1L, null, 10, 0), "하행역은 비어있을 수 없습니다."),
                Arguments.of(new LineRequest("이름", "색상", 1L, 2L, 0, 0), "거리는 양수이어야 합니다.")
        );
    }
    ...
    void createLineWithDuplicateName() {
        LineRequest newLineRequest = new LineRequest("5호선", "bg-purple-600", 1L, 2L, 10, 0);
