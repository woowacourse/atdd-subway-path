...
class LineAcceptanceTest extends AcceptanceTest {
    ...
    void createLine() {
        // given
        LineRequest 신분당선_param = new LineRequest("신분당선", "bg-red-600", 1L, 2L, 10, 900);
    ...
    void getLines() {
        ...
        LineRequest 분당선_param = new LineRequest("분당선", "bg-green-600", 1L, 2L, 10, 900);
    ...
    void updateById() {
        ...
        // when
        LineRequest 다른분당선_param = new LineRequest("다른분당선", "bg-red-600", 1L, 2L, 10, 900);
