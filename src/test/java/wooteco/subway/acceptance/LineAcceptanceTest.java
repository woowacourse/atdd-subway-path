...
public class LineAcceptanceTest extends AcceptanceTest {
    ...
    class CreateLineTest {
        ...
        void 성공시_201_CREATED() {
            ...
            Map<String, Object> params = jsonLineOf("신분당선", "bg-red-600", 1L, 2L, 10, 0);
        ...
        void 정보가_공백으로_구성된_경우_400_BAD_REQUEST() {
            Map<String, Object> blankParams = jsonLineOf("   ", "  ", 1L, 2L, 10, 0);
        ...
        @Test
        void 추가_요금이_음수인_경우_400_BAD_REQUEST() {
            Map<String, Object> negativeFareParams = jsonLineOf("2호선", "초록색", 1L, 2L, 10, -1);

            ExtractableResponse<Response> response = HttpUtils.send(HttpMethod.POST, "/lines", negativeFareParams);
        ...
        void 이미_존재하는_노선명_입력시_400_BAD_REQUEST() {
            testFixtureManager.saveStations("강남역", "선릉역");
            Map<String, Object> duplicateNameParams = jsonLineOf("중복되는 노선명", "bg-red-600", 1L, 2L, 10, 0);
        ...
        void 존재하지_않는_지하철역을_종점으로_입력하면_404_NOT_FOUND() {
            Map<String, Object> params = jsonLineOf("노선명", "색상", 9999L, 2L, 10, 0);
    ...
    class UpdateLineTest {
        ...
        void 성공시_200_OK() {
            ...
            Map<String, Object> params = jsonLineOf("NEW 분당선", "bg-red-800", 10);
        ...
        void 수정하려는_지하철_노선이_존재하지_않는_경우_404_NOT_FOUND() {
            Map<String, Object> params = jsonLineOf("NEW 분당선", "bg-red-600", 10);
        ...
        void 이미_존재하는_지하철_노선_이름으로_수정시_400_BAD_REQUEST() {
            ...
            Map<String, Object> duplicateNameParams = jsonLineOf("존재하는 노선명", "bg-red-600", 10);
        ...
        void 이름_혹은_색상_정보가_공백으로_구성된_경우_400_BAD_REQUEST() {
            Map<String, Object> blankParams = jsonLineOf("   ", "  ", 10);
        ...
        @Test
        void 추가요금을_음수로_수정시_400_BAD_REQUEST() {
            testFixtureManager.saveLine("현재 노선명", "노란색");
            Map<String, Object> negativeFareParams = jsonLineOf("존재하는 노선명", "bg-red-600", -1);

            ExtractableResponse<Response> response = HttpUtils.send(HttpMethod.PUT, "/lines/1", negativeFareParams);

            assertThat(response.statusCode()).isEqualTo(HttpStatus.BAD_REQUEST.value());
        }
    }

    @DisplayName("지하철 노선 제거 테스트")
    @Nested
