...
class LineAcceptanceTest extends AcceptanceTest {
    ...
    void save() {
        ...
        Long downStationId = postStations(new StationSaveRequest("역삼역")).response()
                .as(StationResponse.class)
                .getId();
        LineSaveRequest lineSaveRequest = new LineSaveRequest("신분당선", "bg-red-600", upStationId, downStationId, 3, 100);
    ...
    void findAllLines() {
        ...
        Long downStationId = postStations(new StationSaveRequest("역삼역")).response()
                .as(StationResponse.class)
                .getId();
        postLines(new LineSaveRequest("신분당선", "bg-red-600", upStationId, downStationId, 3, 100));
        postLines(new LineSaveRequest("분당선", "bg-green-600", upStationId, downStationId, 3, 100));
    ...
    void findLine() {
        ...
        Long downStationId = postStations(new StationSaveRequest("역삼역")).response()
                .as(StationResponse.class)
                .getId();
        String location = postLines(new LineSaveRequest("신분당선", "bg-red-600", upStationId, downStationId, 3, 100))
                .header("Location");
