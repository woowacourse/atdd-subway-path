...
public class StationAcceptanceTest extends AcceptanceTest {
    ...
    void createStation() {
        ...
        // then
        StationResponse responseBody = response.getObject(".", StationResponse.class);
        Assertions.assertAll(
                () -> response.assertStatus(HttpStatus.CREATED),
                () -> assertThat(response.getHeader("Location")).isNotBlank(),
                () -> assertThat(responseBody.getName()).isEqualTo("강남역")
        );
    }
    ...
    void getStations() {
        ...
        // then
        List<StationResponse> responseBody = response.getList(".", StationResponse.class);
        Assertions.assertAll(
