...
public class PathAcceptanceTest extends AcceptanceTest {
    ...
    void showShortestPathOfBasicFare() {
        ...
        Long 구호선_id = httpPost("/lines", new LineRequest("9호선", "갈색", 종합운동장역_id, 삼전역_id, 5, 1000)).jsonPath()
                .getLong("id");
        ...
        assertAll(
                ...
                () -> assertThat(pathResponse).usingRecursiveComparison()
                        ...
                        .isEqualTo(new PathResponse(null, 15, 2350))
        );
    }
    ...
    void showShortestPathOfAdditionalFare() {
        ...
        Long 이호선_id = httpPost("/lines", new LineRequest("2호선", "초록색", 교대역_id, 역삼역_id, 15, 1000)).jsonPath()
                .getLong("id");
        Long 신분당선_id = httpPost("/lines", new LineRequest("신분당선", "빨간색", 강남역_id, 양재시민의숲역_id, 20, 2000)).jsonPath()
                .getLong("id");
        ...
        assertAll(
                ...
                () -> assertThat(pathResponse.getFare()).isEqualTo(2910)
        );
    }
