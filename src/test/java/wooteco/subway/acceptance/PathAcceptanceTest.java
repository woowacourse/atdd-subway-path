...
class PathAcceptanceTest extends AcceptanceTest {
    ...
    @Test
    void findPath() {
        PathFixture pathFixture = new PathFixture();
        ExtractableResponse<Response> 경로_조회_응답 = get(PATH_BY_LINE_ID(pathFixture.기흥역_ID, pathFixture.강남역_ID));
    ...
    void findPathWithNotExistStation() {
        ...
        ExtractableResponse<Response> 경로_조회_응답 = get(PATH_BY_LINE_ID(pathFixture.기흥역_ID, 존재하지_않는_역_ID));
