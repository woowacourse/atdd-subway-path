...
public class LineStationAcceptanceTest extends AcceptanceTest {
    ...
    void manageLineStation() {
        ...
        addLineStation(lineResponse.getId(), null, stationResponse1.getId(), 10, 10);
        addLineStation(lineResponse.getId(), stationResponse1.getId(), stationResponse2.getId(), 10, 10);
        addLineStation(lineResponse.getId(), stationResponse2.getId(), stationResponse3.getId(), 10, 10);
