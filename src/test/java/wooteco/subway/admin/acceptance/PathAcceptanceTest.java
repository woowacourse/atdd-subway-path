...
public class PathAcceptanceTest extends AcceptanceTest {
    ...
    void searchShortestDistancePath() {
        ...
        PathResponse path = getShortestPath(station1.getName(),
    ...
    private PathResponse getShortestPath(String source, String target,
        String pathType) {
        return given().
