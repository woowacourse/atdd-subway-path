...
public class LineServiceTest {
    ...
    void setUp() {
        ...
        line = new Line(1L, "2호선", "white", LocalTime.of(05, 30), LocalTime.of(22, 30), 5);
    ...
    @Test
    void wholeLines() {
        Line newLine = new Line(2L, "신분당선", "black", LocalTime.of(05, 30), LocalTime.of(22, 30), 5);
        ...
        Set<Station> stations1 = Sets.newLinkedHashSet(new Station(1L, "강남역"),
            new Station(2L, "역삼역"), new Station(3L, "삼성역"));
        Set<Station> stations2 = Sets.newLinkedHashSet(new Station(4L, "양재역"),
