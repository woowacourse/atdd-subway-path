...
public class LineServiceTest {
	...
	@BeforeEach
	void setUp() {
		line = new Line(1L, "bg-green-600", "2호선", LocalTime.of(5, 30), LocalTime.of(22, 30), 5);
	...
	void addLineStationAtTheFirstOfLine() {
		LineStationCreateRequest request = new LineStationCreateRequest(null, 4L, 0, 0);
	...
	@Test
	void wholeLines() {
		Line newLine = new Line(2L, "신분당선", "bg-red-600", LocalTime.of(5, 30), LocalTime.of(22, 30),
			5);
		newLine.addLineStation(new LineStation(null, 2L, 0, 0));
		...
		System.out.println(lineService.wholeLines());
		List<LineResponse> lineResponses = lineService.wholeLines().getLineDetails();
