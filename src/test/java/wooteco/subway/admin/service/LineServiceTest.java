...
public class LineServiceTest {
	...
	void wholeLines() {
		...
		when(lineRepository.findById(1L)).thenReturn(Optional.of(this.line));
		...
		when(stationRepository.findAllById(Arrays.asList(4L, 5L, 6L)))
			.thenReturn(Arrays.asList(stations.get(3), stations.get(4), stations.get(5)));
