...
public class PathServiceTest {
	...
	void setUp() {
		...
		lineThree.addLineStation(new LineStation(FIRST_PRE_STATION_ID, station5.getId(), 0, 0));
	}
	...
	void shortestDurationPathWithSameSourceTarget(String type) {
		...
		assertThatThrownBy(() -> pathService.findShortestPath(new PathRequest(STATION_NAME1, STATION_NAME1, type)))
