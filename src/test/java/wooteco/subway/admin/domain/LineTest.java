...
public class LineTest {
	...
	@BeforeEach
	void setUp() {
		line = new Line(1L, "2호선", "bg-green-600", LocalTime.of(5, 30), LocalTime.of(22, 30), 5);
	...
	@Test
	void update() {
		Line line = new Line(1L, "2호선", "bg-green-600", LocalTime.of(5, 30), LocalTime.of(22, 30),
			5);
		Line updateLine = new Line(1L, "3호선", "bg-yellow-600", LocalTime.of(6, 30),
			LocalTime.of(6, 30),
			10);
	...
	void addLineStation_sequentialAddStation() {
		line = new Line(2L, "3호선", "bg-yellow-600", LocalTime.of(5, 30), LocalTime.of(22, 30), 5);
		LineStation firstLineStation = new LineStation(null, 1L, 0, 0);
	...
	void addLineStation_reverseSequentialAddStation() {
		line = new Line(2L, "3호선", "bg-yellow-600", LocalTime.of(5, 30), LocalTime.of(22, 30), 5);
		LineStation firstLineStation = new LineStation(null, 1L, 0, 0);
		LineStation overwriteFirstLineStation = new LineStation(null, 2L, 0, 0);
		line.addLineStation(firstLineStation);
