...
class FareByAgeTest {
    ...
    void checkForFree() {
        //given
        int 아이_가격 = FareByAge.calculateFare(5, 1500);
        int 노인_가격 = FareByAge.calculateFare(65, 1500);
        //when
        //then
        assertAll(
    ...
    void checkForChild() {
        //given
        int 어린이1_가격 = FareByAge.calculateFare(6, 1500);
        int 어린이2_가격 = FareByAge.calculateFare(12, 1500);
        //when
        //then
        assertAll(
    ...
    void checkForTeenager() {
        //given
        int 청소년1_가격 = FareByAge.calculateFare(13, 1500);
        int 청소년2_가격 = FareByAge.calculateFare(17, 1500);
        //when
        //then
        assertAll(
    ...
    void checkForGeneral() {
        //given
        int 일반1_가격 = FareByAge.calculateFare(18, 1500);
        int 일반2_가격 = FareByAge.calculateFare(64, 1500);
        //when
        //then
        assertAll(
