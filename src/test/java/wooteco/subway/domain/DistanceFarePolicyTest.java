...
class DistanceFarePolicyTest {
    ...
    void valueOfUnder10(int distance) {
        assertThat(DistanceFarePolicy.valueOf(distance)).isEqualTo(0);
    }
    ...
    void valueOfOver10Under50(int distance, int expected) {
        assertThat(DistanceFarePolicy.valueOf(distance)).isEqualTo(expected);
    }
    ...
    void valueOfOver50(int distance) {
        assertThat(DistanceFarePolicy.valueOf(distance)).isEqualTo(900);
    }
