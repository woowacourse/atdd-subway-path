...
class AgeDisCountPolicyTest {
    ...
    void ageDiscountBaby(final int age) {
        assertThat(AgeDisCountPolicy.from(age)).isEqualTo(BABY);
    }
    ...
    void ageDiscountChildren(final int age) {
        assertThat(AgeDisCountPolicy.from(age)).isEqualTo(CHILDREN);
    }
    ...
    void ageDiscountTeenager(final int age) {
        assertThat(AgeDisCountPolicy.from(age)).isEqualTo(TEENAGER);
    }
    ...
    void ageDiscountAdult(final int age) {
        assertThat(AgeDisCountPolicy.from(age)).isEqualTo(ADULT);
    }
