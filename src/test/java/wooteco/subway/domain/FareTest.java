...
class FareTest {
    ...
    void calculateBasicFare(int distance, int expected) {
        Fare fareCalculator = new Fare(FarePolicyFactory.from(distance), DiscountPolicyFactory.from(22));
    ...
    void calculateChildrenFare(int distance, int expected) {
        Fare fareCalculator = new Fare(FarePolicyFactory.from(distance), DiscountPolicyFactory.from(10));
        int fare = fareCalculator.calculate(distance, 0);
    ...
    void calculateTeenagerFare(int distance, int expected) {
        Fare fareCalculator = new Fare(FarePolicyFactory.from(distance), DiscountPolicyFactory.from(15));
        int fare = fareCalculator.calculate(distance, 0);
    ...
    void calculatePreferentialFare(int distance, int expected) {
        Fare fareCalculator = new Fare(FarePolicyFactory.from(distance), DiscountPolicyFactory.from(65));
        int fare = fareCalculator.calculate(distance, 0);
