...
class AgeTest {
    ...
    @ParameterizedTest
    @CsvSource(value = {"0,INFANTS", "5,INFANTS", "6,CHILDREN", "12,CHILDREN", "13,TEENAGERS", "18,TEENAGERS", "19,ADULTS", "25,ADULTS"})
    ...
    @ParameterizedTest
    @CsvSource(value = {"INFANTS,0", "CHILDREN,450", "TEENAGERS,720", "ADULTS,1250"})
