...
public class LineDaoTest {
    ...
    void findById() {
        ...
        LineEntity findLine = lineDao.findById(line.getId()).orElseThrow();
    ...
    void modifyById() {
        ...
        lineDao.modifyById(new LineEntity(savedLine.getId(), "2호선", "red", savedLine.getExtraFare()));
        LineEntity updateLine = lineDao.findById(savedLine.getId()).orElseThrow();
