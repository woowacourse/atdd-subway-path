...
class LineDaoTest {
    ...
    private static final Integer LINE_EXTRA_FARE = 500;
    ...
    public void save() {
        // given
        LineEntity entity = new LineEntity(LINE_NAME, LINE_COLOR, LINE_EXTRA_FARE);
        // when
    ...
    public void findAll_afterSaveOneLine() {
        // given
        dao.save(new LineEntity(LINE_NAME, LINE_COLOR, LINE_EXTRA_FARE));
        // when
        List<LineEntity> lines = dao.findAll();
        // then
    ...
    public void findById() {
        // given
        final Long id = dao.save(new LineEntity(LINE_NAME, LINE_COLOR, LINE_EXTRA_FARE));
        // when
    ...
    public void update() {
        ...
        final Long id = dao.save(new LineEntity(LINE_NAME, LINE_COLOR, LINE_EXTRA_FARE));
        // when
        final Long updatedId = dao.update(new LineEntity(id, "구분당선", "구색깔", 800));
        // then
    ...
    public void update_throwsExceptionWithInvalidId() {
        // given
        dao.save(new LineEntity(LINE_NAME, LINE_COLOR, LINE_EXTRA_FARE));
        LineEntity updateLine = new LineEntity(100L, "우테코역", "색깔", 900);
        // when
