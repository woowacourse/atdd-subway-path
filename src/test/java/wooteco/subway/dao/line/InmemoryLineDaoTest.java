...
class InmemoryLineDaoTest {
    ...
    void findById() {
        long id = inmemoryLineDao.save(new Line("신분당선", "bg-red-600", 100));
    ...
    void findAll() {
        inmemoryLineDao.save(new Line("신분당선", "bg-red-600", 100));
        inmemoryLineDao.save(new Line("분당선", "bg-green-600", 100));
    ...
    void update() {
        long id = inmemoryLineDao.save(new Line("신분당선", "bg-red-600", 100));
        int result = inmemoryLineDao.update(new Line(id, "분당선", "bg-red-600", 100));
