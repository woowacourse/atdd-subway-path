...
public class JdbcLineDaoTest {
    ...
    void setUp() {
        ...
        final Line line1 = new Line("분당선", "bg-red-600", 900);
        final Line line2 = new Line("신분당선", "bg-orange-600", 900);
        lineDao.save(line1);
        lineDao.save(line2);
    }
    ...
    void findLine() {
        final Line expected = new Line("다른분당선", "bg-blue-600", 900);
    ...
    void update() {
        final Line line3 = new Line("다른분당선", "bg-blue-600", 900);
