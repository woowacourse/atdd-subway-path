...
public class SectionAcceptanceTest extends AcceptanceTest {
    ...
    void addLineSection() {
        ...
        // then
        지하철_구간_생성됨(response, 신분당선, Arrays.asList(강남역, 양재역, 광교역), tokenResponse);
    }
    ...
    void addLineSection2() {
        ...
        // then
        지하철_구간_생성됨(response, 신분당선, Arrays.asList(정자역, 강남역, 양재역, 광교역), tokenResponse);
    }
    ...
    private void 지하철_구간_생성됨(ExtractableResponse<Response> result, LineResponse lineResponse, List<StationResponse> stationResponses,  TokenResponse tokenResponse) {
