...
public class JdbcSectionDao implements SectionDao {
    ...
    public List<Section> findAllByLineId(final long lineId) {
        final String sql = "select s.id as id, s.line_id as line_id, li.name as line_name, li.color as line_color, "
                + "li.extraFare as extraFare, us.id as us_id, us.name as us_name,"
                + "ds.id as ds_id, ds.name as ds_name, s.distance as distance from SECTION as s "
                + "join LINE as li on li.id = s.line_id "
