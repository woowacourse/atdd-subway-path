...
public class SectionService {
    ...
    public void insert(SectionRequest sectionRequest, Long lineId) {
        ...
        Section inputSection = new Section(upStation, downStation, sectionRequest.getDistance());

        checkPresentSections(lineId, inputSection);
    ...
    private void checkPresentSections(Long lineId, Section inputSection) {
