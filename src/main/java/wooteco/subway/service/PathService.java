...
public class PathService {
    ...
    private PathsResponse createPathsResponse(final Station source, final Station target, final int age) {
        ...
        return PathsResponse.of(paths, calculateFare(paths, age));
    }
