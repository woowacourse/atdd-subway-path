...
public class LineResponse {
    ...
    public LineResponse(Long id, String name, LocalTime startTime, LocalTime endTime, int intervalTime, String backgroundColor, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.id = id;
        this.name = name;
