...
class FirstAddFarePolicyStrategy implements FarePolicyStrategy {

    private static final int LOWER_BOUND_DISTANCE = 10;
    private static final int KILOMETER_UNIT = 5;
    private static final int ADDED_FARE = 100;

    @Override
    public int calculateFare(int distance) {
        return new BasicFarePolicyStrategy().calculateFare(LOWER_BOUND_DISTANCE)
