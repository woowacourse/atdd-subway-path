...
public class NavigatorJgraphtAdapter2 implements Navigator2<Station, Section> {
    ...
    private NavigatorJgraphtAdapter2(DijkstraShortestPath<Station, SectionEdge> dijkstraPath) {
        this.dijkstraPath = dijkstraPath;
    }

    public static NavigatorJgraphtAdapter2 of(List<Section> sections) {
        DijkstraShortestPath<Station, SectionEdge> shortestPath = new DijkstraShortestPath<>(toGraph(sections));
        return new NavigatorJgraphtAdapter2(shortestPath);
    }
