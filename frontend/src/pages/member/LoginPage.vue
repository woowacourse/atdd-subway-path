  ...
  methods: {
    ...
    async onLogin() {
      ...
      try {
        ...
        let token_response = await fetch("/login/token", {
          method: "POST",
          headers: {
        ...
        let member_response = await fetch("/members/me", {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
        ...
        member_response = await member_response.json()
        this.setMember(member_response);
